...
docker build ./dashboard-core -t registry.cn-hangzhou.aliyuncs.com/zhqn/k8s-dashboard-core:1.0.0 && \
docker push registry.cn-hangzhou.aliyuncs.com/zhqn/k8s-dashboard-core:1.0.0